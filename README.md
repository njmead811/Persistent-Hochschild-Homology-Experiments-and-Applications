This repository contains the experiments for an in-progress paper called "Persistent Reachability in Machine Learning". The two experiments are as follows:
